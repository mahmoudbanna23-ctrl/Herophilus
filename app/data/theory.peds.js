  ...
  "liver": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "### The Kasai portoenterostomy\n\n- **What is done:** the **damaged bile ducts and the gallbladder are removed** and the **small intestine is connected directly to the liver**, so bile drains from the porta hepatis into the bowel.\n- **⚠️ When:** **before 6 weeks of age.** Early KPE **is critical for BA survival**.\n\n### The two \"key considerations\" the deck closes on\n\n- **Cholestatic jaundice is always pathologic** and indicates **hepatobiliary dysfunction**.\n- **Early detection:** by the **primary care physician**, with **timely referral to the paediatric gastroenterologist / hepatologist** — both are **important contributors to optimal treatment and prognosis**.\n\n### ⚠️ Medical management — the deck lists this as an objective and prints no slide for it\n\n*Everything in this block is supplied (not taken from the course material). The lecture's objective 9 is \"Management of Neonatal Cholestasis\" and no slide carries any.*\n\n- **Fat-soluble vitamins:** replace **A, D, E and K** — K first and by injection where there is coagulopathy.\n- **Nutrition:** a **medium-chain triglyceride (MCT) formula**, which is absorbed without bile salts, plus high-calorie feeding for the failure to thrive.\n- **Bile flow:** **ursodeoxycholic acid**.\n- **Pruritus:** ursodeoxycholic acid, rifampicin or cholestyramine.\n- **Cause-specific:** **lactose-free feeds** in galactosaemia, antimicrobials for a treatable congenital infection.\n- **When Kasai fails or is too late:** **liver transplantation** — biliary atresia is the commonest paediatric indication for it.\n\nSrc: L43 pp.60, 62–63 (p.60 image-only, the operation recovered by render)",
        "flow": {
          "title": "The jaundiced infant — the approach, and where the clock starts",
          "steps": [
            {
              "k": "step",
              "t": "An infant is jaundiced. Ask ONE question first: how old is the baby?",
              "n": "the age is the trigger"
            },
            {
              "k": "decision",
              "t": "Still jaundiced after 2 WEEKS of age?",
              "yes": "Fractionate — send TOTAL AND DIRECT bilirubin now",
              "no": "Manage as neonatal jaundice — see the chapter `neonatal`"
            },
            {
              "k": "decision",
              "t": "Direct bilirubin > 1 mg/dL (total <= 5), or > 20 % of total (total > 5)?",
              "yes": "This is CHOLESTASIS. Always pathologic. Go on",
              "no": "Unconjugated hyperbilirubinaemia — `neonatal` owns the causes and the phototherapy thresholds"
            },
            {
              "k": "alert",
              "t": "CHECK THE STOOL AND THE NAPPY. Pale, clay-coloured or white stool with dark urine is severe bile-flow obstruction until proven otherwise. Match against the stool colour card: panels 1-6 abnormal, 7-9 normal",
              "n": "the bedside sign that costs nothing"
            },
            {
              "k": "step",
              "t": "First-line labs — total and direct bilirubin, AST, ALT, GGT, alkaline phosphatase, PT/INR, CBC, sepsis workup if the newborn is sick, and REDUCING SUBSTANCE IN URINE for galactosaemia",
              "n": "step 1"
            },
            {
              "k": "step",
              "t": "Abdominal ultrasound — a small gall bladder or the TRIANGULAR CORD SIGN points to biliary atresia; it may also show a choledochal cyst",
              "n": "step 2"
            },
            {
              "k": "alert",
              "t": "THE WHOLE POINT IS TO IDENTIFY BILIARY ATRESIA WITHIN THE FIRST 6 WEEKS OF LIFE. Percutaneous liver biopsy, 96.9 % accurate at separating obstructive jaundice from neonatal hepatitis, is highly recommended BEFORE 6 weeks",
              "n": "step 3 — the deadline"
            },
            {
              "k": "decision",
              "t": "Biopsy and ultrasound point to biliary atresia?",
              "yes": "Operative cholangiography, the gold standard, then KASAI PORTOENTEROSTOMY BEFORE 6 WEEKS OF AGE",
              "no": "Second line: metabolic workup (galactosaemia, alpha-1 antitrypsin deficiency, cystic fibrosis), TORCH screen, genetic panels for PFIC and Alagille"
            },
            {
              "k": "step",
              "t": "Whatever the cause: refer early to the paediatric gastroenterologist or hepatologist. Early detection and timely referral are what change the prognosis",
              "n": "the deck closes on this"
            }
          ]
        },
        "qs": []
