...
// STATUS: IN PROGRESS, STOPPED AFTER STAGING n:22 (complete on p.108, no straddle). 21 questions
//   staged (n:1-10,12-22; n:11 confirmed absent, publisher skip). This resuming (third) pass staged
//   n:18-22 from scratch at 600 dpi: n:18/19 fully confirmed on p.107, n:20 confirmed straddling
//   p.107->p.108, n:21/22 confirmed complete on p.108. Every numeral and key for n:18-22 below is
//   freshly confirmed this pass, not adopted from either prior pass's sighting (the sighting in the
//   inherited note for n:18/19 turned out correct on every point — see "PLACES WRONG" below).
//   Task-prompt count hint = 27 (highest printed number 28, Q11 skipped by the publisher) —
//   CONFIRMED for the Q11 skip; total count STILL OPEN past p.108 (Q23 seen starting on p.108,
//   not yet staged, straddling onward — see STOPPED HERE).
//
...
{ n:20, p:'107', boiler:false,
  ...
  opts:['Oral corticosteroid','Inhaled salbutamol via metered dose inhaler and spacer','Oral antipyretic/analgesic','Continuous positive airway pressure (CPAP)','Endotracheal intubation and ventilation'],
  key:'A',
  note:'⚠️ STRADDLES THE PAGE BREAK p.107 -> p.108 — the stem and options A-C print on p.107, the box runs off the bottom of the page after option C, and options D ("Continuous positive airway pressure (CPAP)") and E ("Endotracheal intubation and ventilation") plus "Answer: A." print at the very top of p.108, above the next divider and before Q21 begins. No boiler line — stem runs straight into option A, inspected directly on the full-page render. All numerals re-rendered and confirmed at 600 dpi in a single verifying band spanning the whole stem (crop p107-q20-locate.png, wider than the ~1150px guidance at 2900px but every character stayed legible even scaled down for display, so read as one band rather than several narrower ones): "7-month-old", "2-day history of fever and runny nose", "respiratory rate is 30 breaths/min", "temperature of 37.8°C", "oxygen saturation is 96% in air" — all confirmed. Three individual narrower crops attempted first (p107-q20-age.png/2day.png/rr.png/temp.png/sat.png) all missed the target line by roughly two line-heights on the first proportional estimate; abandoned in favour of the one wide verifying band, which landed correctly first try. Key "Answer: A." confirmed at 600 dpi on p.108 (crop p108-q20-key.png), bare letter, no option name — letter-vs-name cross-check unavailable. No figure — box examined whole on both p.107 and p.108, none printed. SHARED MENU: prints the identical five-option menu opened by n:18/n:19 (Oral corticosteroid / Inhaled salbutamol via MDI+spacer / Oral antipyretic-analgesic / CPAP / Endotracheal intubation and ventilation), same order, no duplicate option. Discriminating token: harsh cough with noisy inspiration and moderate inspiratory stridor, mild recession, low-grade fever, sat 96% — croup picture not requiring CPAP/intubation, but airway obstruction, not simple URTI — matching key A (oral corticosteroid), the standard first-line treatment for moderate croup. DUPLEX SHOW-THROUGH noted but not transcribed: a faint mirrored heading reading approximately "Diabetes &..." shows through p.108 behind options D/E of this box — predicted, per the proven pairing (LEFT half of odd sheet 55 <-> RIGHT half of sheet 56, three book pages away, i.e. p.111), to be the ch.14 banner ghosting from p.111; to be confirmed word-for-word against a direct render of p.111 at the boundary check, never read off this ghost.' },
...
{ n:22, p:'108', boiler:false,
  ...
  key:'E',
  note:'Complete on p.108, no straddle. No boiler line — stem runs straight from "...care for this child?" into option A, confirmed directly in the same crop as the numerals. Whole box (stem, all five options and the key) verified in a single 600 dpi verifying band (crop p108-q22-locate.png, 2650 px wide — over the ~1150px guidance but every numeral stayed crisp even scaled down for display, same finding as n:20\'s locate crop): "4-year-old", "200 micrograms BD", "3 months", option B "400 micrograms BD", all confirmed, landed first try. Key "Answer: E." confirmed in the same crop, bare letter, no option name — letter-vs-name cross-check unavailable. No figure — box examined whole, none printed. No shared menu — this box\'s five options are unique to it. Discriminating token: reliever use escalated to every-other-day plus increased nocturnal cough despite an already-prescribed preventative steroid inhaler and reliever — poor control on current regimen, next step is to add a long-acting beta agonist, matching key E.' },
];
