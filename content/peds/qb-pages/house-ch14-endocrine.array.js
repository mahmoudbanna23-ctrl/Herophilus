...
var PEDHD_ENDO_STAGED = [
  ...
  { n:6, p:"113", boiler:true,
    ...
    key:1,
    straddle:true,
    note:"STRADDLES THE PAGE BREAK p.113 -> p.114 PRINTED DEFECT, transcribed as printed and NOT corrected: the book gives creatinine as '30 mmol/L (normal range 20-65 mmol/L)'. Creatinine is reported in micromol/L; as printed the value and its range are out by a factor of 1000. Read against p.113 by eye, 2026-09-03 - the page really does print mmol/L on that line. Record in the explanation, do not change the stem." },
  ...
  { n:14, p:"116", boiler:false,
    ...
    key:3,
    note:"PRINTED DEFECT, transcribed as printed and NOT corrected: the book gives 'His blood glucose is 2.0' with NO UNIT, where every other glucose in this chapter is written 'mmol/L'. Read against p.116 by eye, 2026-09-03 - the unit really is absent on the page. Record in the explanation, do not supply the unit in the stem." },
