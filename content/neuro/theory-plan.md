...
4. ✅ **Written — 30 of 34** *(measured from disk 2026-08-23; the module went 33 → 34 when
   ...
   **`nr-exam`** · **`nr-cns`** · **`ps-somato`** · **`ps-child`**.
   **281 sections, 94,735 body words.** ✅⚠️ **ALL 151 OF THE MODULE'S QUESTIONS ARE NOW REACHABLE
   FROM THEORY — it was 130 before `nr-intro`/`nr-exam` landed, and the remaining 21 were all in
   that one chapter.**
   **FOUR chapters remain and NOT ONE CARRIES A QUESTION** — `ps-interview` · `ps-osce` ·
   `ps-geri` · `nr-delirium`. ⚠️ *An earlier version of this
