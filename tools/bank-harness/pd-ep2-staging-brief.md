...
⚠️ **A TALLY HELPS BUT DOES NOT FIX IT — five measurements now, 2026-09-04.** Reconstructed-afterwards counts have been low by about 40% every time (30 against 64, 10 against 17). Kept-as-you-go tallies were right three times (55, 18, and 63 against a harness-recorded 66) — and then a section 3 staging agent kept a running tally, said so explicitly, itemised the three calls it wasted on a mistake, and reported **51** against a harness-recorded **83**. That is a 39% under-count from an agent doing everything asked. **So the honest instruction is not "tally and you will be right".** It is: tally as you go, say it is a tally, and treat your own number as a floor rather than a measurement. If the step budget matters, stop earlier than your count says you need to. An earlier version of this paragraph claimed the tally had solved the problem; the very next agent disproved it, and the claim is corrected here rather than quietly dropped.
