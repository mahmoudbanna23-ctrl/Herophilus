...
global.window={};
const S=eval(fs.readFileSync(P+'content/peds/qb-pages/house-ch04-haem.array.js','utf8')+';PEDHD_HAEM_STAGED');
...
const Sx=S.map(q=>({k:'ch4-Q'+q.n,q,t:tok(q.stem),c:content(q.stem),tt:N.tight(q.stem),
