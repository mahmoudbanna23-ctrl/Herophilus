# Herophilus — reference annex (full detail behind CLAUDE.md)

**This is the pre-2026-08-17 rules file, preserved whole.** `CLAUDE.md` was distilled to cut its
per-request token cost; nothing was deleted — it is all here in the original section order and
numbering. **Where this file and `CLAUDE.md` disagree, `CLAUDE.md` wins** — in particular §4's
"Theory" subsection below is the DEAD 2026-08-04 brief, superseded by `START-HERE.md` §14.
Open this file when a `CLAUDE.md` pointer sends you here.
