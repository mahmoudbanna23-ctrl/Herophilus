...
1. **GRADE GAIN IS OPEN — `ENT QB.pdf`, contents page promises 1,080** (Ear 244, Nose 258, Throat 578
   ...
   **⚠️⚠️ RESUME AT THROAT TOPIC 4, "Tonsils and Adenoids", book p.110 (PDF 119) — opens at Q149, 98 promised (THE LARGEST TOPIC IN THE BOOK), answers begin book p.121 (PDF 130), topic 5 opens book p.124. PDF 119 ALREADY RENDERED at `<scratchpad>\thr3\`.** Check §14's map, **render one page past the last answer page**, and **expect the question tail to share the answer page until proved otherwise.** Throat = **11 topics, 578 promised — larger than Ear and Nose combined.** **✅ t1 40/40 (34+6); ✅ t2 47/46 (45+2), all in `ent-pharsupp`; ✅ t3 61/60 (58+3), the largest chapter yet.**
