...
- **Corpus 2,699** (2026-08-24, House CLOSED — measured per module, not derived): ENT **2,322**
  (2,240 q + 82 cases) · Neuro 158 (151 + 7) · Ophtho 138 · Peds 81; **89 cases**. ENT-file banks
  **GG 1,101 · house 779 · endpoint 615**. Module keys `ent`, `ophtho`, `pediatrics`, `neuropsych`.
