...
const MODULES = [
  ...
  {id:'neuropsych', name:'Neuropsychiatry', icon:'labyrinth', color:'var(--neuro)', hex:'#6d4c7d', groups:[
  ...
  {id:'pediatrics', name:'Pediatrics', icon:'infant', color:'var(--peds)', hex:'#2e5f8a', groups:[
