# Progress ledger — LIVE. Sections 17 onward (ophthalmology, peds, neuro).

What has been read, transcribed, and written. **This file is load-bearing** — the source material
is large enough that the work spans many sessions, and this is what makes it resumable. Update it
in the same pass as the work, never afterwards from memory.

Rule: a scanned page is rendered and read **once, ever**. Before opening any source, check here.

> ## ⚠ SECTIONS 1-16 ARE IN `ledger-closed-1-16.md`
> Split on 2026-09-01 because the combined file had reached **~207k tokens, larger than the
> context window** — it had become unopenable. **Nothing was deleted and no section was
> renumbered.** A reference written anywhere as `ledger.md` §7 / §11 / §11a / §13 / §14 / §15 / §16
...
| Section | File | Line |
|---|---|---|
| 1. Lecture slide text harvest (Phase 1) | ledger-closed-1-16.md | 33 |
| 2. Question bank transcription (Phase 2) | ledger-closed-1-16.md | 73 |
| THE NOSE SECTION IS COMPLETE — 2026-07-27 | ledger-closed-1-16.md | 754 |
| 3. Book reads (Phase 4 support) | ledger-closed-1-16.md | 932 |
| 4. Theory chapters written (Phase 4) | ledger-closed-1-16.md | 957 |
| 5. Blocked | ledger-closed-1-16.md | 971 |
| 6. Next action | ledger-closed-1-16.md | 977 |
| 7. How `ENT endpoint.pdf` behaves — learned the hard way | ledger-closed-1-16.md | 1031 |
| §8 Decisions log — moved here from MEMORY.md on 2026-07-27 | ledger-closed-1-16.md | 2081 |
| §9 Source material inventory — moved here from MEMORY.md on 2026-07-27 | ledger-closed-1-16.md | 2160 |
| §10 Corrections made to earlier records — moved here from MEMORY.md on 2026-07 | ledger-closed-1-16.md | 2190 |
| §11 Owed in the end-of-ENT review — detail, moved here from MEMORY.md on 2026- | ledger-closed-1-16.md | 2221 |
| §11b Exam Night Review — resolution, 2026-08-04 | ledger-closed-1-16.md | 2306 |
| §11a Question images — built 2026-08-04 | ledger-closed-1-16.md | 2638 |
| §12 Design history — moved here from MEMORY.md on 2026-07-28 | ledger-closed-1-16.md | 2742 |
| §13 Environment facts — moved here from MEMORY.md on 2026-07-28 | ledger-closed-1-16.md | 2841 |
| §14 `ENT QB.pdf` — Grade Gain. Reconnaissance, 2026-08-07 | ledger-closed-1-16.md | 2943 |
| §14aa — Grade Gain, Throat topic 8: "Stridor & Tracheotomy" (closed 2026-08-12 | ledger-closed-1-16.md | 6970 |
| §14cc — Grade Gain, Throat topic 11 "Clinical Assessment of Voice" — CLOSED 20 | ledger-closed-1-16.md | 7226 |
| §14dd — Grade Gain, Throat topic 10 "Hoarseness Of Voice" — CLOSED 2026-08-23. | ledger-closed-1-16.md | 7306 |
| Ophthalmology banks — the real state, measured 2026-08-18 | ledger-closed-1-16.md | 7481 |
| §15 — Dr. HOUSE in ENT: EAR section swept and drafting, NOSE section swept — 2 | ledger-closed-1-16.md | 7584 |
| §15p — House ENT, the Q391–Q685 duplicate sweep (2026-08-23) | ledger-closed-1-16.md | 8243 |
| §15q — House ENT transcription, book pp.172–179 (PDF 87–90), 2026-08-23 | ledger-closed-1-16.md | 8357 |
| §15r — House ENT, book pp.180–187 (PDF 91–94): ✅ THE FOURTH SECTION BOUNDARY I | ledger-closed-1-16.md | 8423 |
| §15s — House ENT, book pp.196–205 (PDF 99–103): ✅ THE BOOK IS TRANSCRIBED TO I | ledger-closed-1-16.md | 8496 |
| §15t — House ENT, book pp.188–195 (PDF 95–98): ✅ TRANSCRIPTION OF THE BANK IS  | ledger-closed-1-16.md | 8560 |
| §15u — House drafting, batch 1 (Q391–Q421, book pp.108–114), 2026-08-23 | ledger-closed-1-16.md | 8661 |
| §15v — House drafting, batch 2 (Q422–Q450, book pp.115–120), 2026-08-23 | ledger-closed-1-16.md | 8729 |
| §15w — House drafting, batches 3 and 4, 2026-08-23 | ledger-closed-1-16.md | 8781 |
| §15x — House drafting, batches 5 and 6, 2026-08-23 | ledger-closed-1-16.md | 8861 |
| §15y — House drafting, batch 8 (Q651–Q685, book pp.165–171), 2026-08-23 | ledger-closed-1-16.md | 8946 |
| §15z — House drafting, batch 7 and the close of the run (2026-08-23) | ledger-closed-1-16.md | 9026 |
| §15aa — the 211 Throat entries are SPLICED and the app BOOTS (2026-08-24) | ledger-closed-1-16.md | 9104 |
| §15bb — the tail sweep: the fourth section is 100 % duplicated, and it is not  | ledger-closed-1-16.md | 9158 |
| §15cc — the 83 folds are APPLIED, and the harness had to be widened twice firs | ledger-closed-1-16.md | 9244 |
| §15dd — ⚠️⚠️ THE TOLERANCE THAT CATCHES A TYPO ALSO COLLAPSES AN ENUMERATION | ledger-closed-1-16.md | 9333 |
| §15ee — the fourth section is the ENDPOINT BANK, printed again | ledger-closed-1-16.md | 9389 |
| §15ff — the tail is adjudicated: 149 verdicts, and the fourth section adds NOT | ledger-closed-1-16.md | 9525 |
| §15gg — the comparator, rebuilt from measurement instead of a tolerance | ledger-closed-1-16.md | 9573 |
| §15hh — the 25 tail entries to draft, chaptered from where the corpus already  | ledger-closed-1-16.md | 9624 |
| §15ii — a standing rule was OVERRIDDEN once, deliberately, and here is the arg | ledger-closed-1-16.md | 9654 |
| §15jj — the 124 tail folds are APPLIED | ledger-closed-1-16.md | 9690 |
| §15kk — the shipped duplicate is merged, and the four tail crops are cut (2026 | ledger-closed-1-16.md | 9749 |
| §15ll — the image field takes no extension, and the harness that checked it ha | ledger-closed-1-16.md | 9899 |
| §15mm — the 25 tail entries are written and spliced: HOUSE ENT IS CLOSED (2026 | ledger-closed-1-16.md | 9961 |
| §16 — ENT THEORY'S TWO STANDING DEBTS ARE CLOSED, AND ONE OF THEM WAS ALMOST E | ledger-closed-1-16.md | 10101 |
| §17 — OPHTHALMOLOGY REOPENS: HOUSE CH.1 MERGED, AND THE MODULE'S BLIND DECKS F | ledger.md | 76 |
| §17q — OCR gate calibration against shipped ground truth (2026-08-30) | ledger.md | 1448 |
| §17r — House ch.14 "Neuro-ophthalmology" — 28 shipped, 1 folded (2026-08-30) | ledger.md | 1504 |
