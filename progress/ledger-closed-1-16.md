# Progress ledger, PART 1 of 2 — sections 1 to 16. CLOSED.

**46 of the 47 sections here are ENT, whose banks closed 2026-08-23. The exception is
*Ophthalmology banks — the real state, measured 2026-08-18* at line 7481, which is
superseded by section 17 in the live ledger and by `briefs/ophtho-bank-brief.md`.**

**Split out of `ledger.md` on 2026-09-01. Not one byte of the text below was changed.**

The combined file had reached 841,939 chars / 11,854 lines, about **207k tokens — larger than a
200k context window.** It could not be opened at all. Everything here is the ENT module, whose
banks closed 2026-08-23; the live ledger (`ledger.md`) now starts at section 17, where
ophthalmology reopens.

**Section numbers are unchanged.** A pointer written elsewhere as `ledger.md` §11 or `ledger.md`
§13 still means the section numbered that way, and it is in this file. The index at the top of
`ledger.md` says which file each section is in and on what line.

**Do not read this file whole (~177k tokens).** `grep -n "^## "` it, then `sed -n '<a>,<b>p'`.
