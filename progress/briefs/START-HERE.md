...
| `op-systemic` (L23 ll.301–322) | **Metastases, lymphoma and leukaemic infiltrates as TUMOURS** — written here as the systemic malignancy link only | `op-onc` | ☐ **⚠️ receiver blocked on a visual read (`L24`, 78 pp)** |
...
| `op-red` (L37) | **Conjunctivitis in full** (types, membranes, neonatal, trachoma) · **pterygium in full** (pathology, pinguecula, grading, autograft) | `op-conj` | ☐ **⚠️ blocked on `L6`'s owed visual read** |
...
| `op-red` (L37) | **Lid disease in full, plus lid tumours** | `op-lid` | ☐ **⚠️ blocked on `L5`'s owed read (47 slides / 127 media / 365 w)** |
