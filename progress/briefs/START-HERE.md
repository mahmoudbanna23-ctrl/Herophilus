...
| `op-red` (L37) | **Conjunctivitis in full** (types, membranes, neonatal, trachoma) · **pterygium in full** (pathology, pinguecula, grading, autograft) | `op-conj` | ☐ ⚠️ **BLOCKER SUPERSEDED 2026-08-18 — the payload now comes from the BOOK, not the deck.** `ophthalmology.pdf` (HEALIX) **ch.6 Conjunctiva, printed 82–95 — 14 pages, exam weight 6.5 %** replaces `L6`'s 66 slides of 5.2 words each. Deliverable; the deck read it was waiting on is not owed |
