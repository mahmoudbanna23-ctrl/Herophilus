...
| `op-systemic` (L23 ll.336–355) | **AION and the ocular motor palsies** — written here only as the vascular/syphilitic associations | `op-neuro`, `op-acute` | ☐ **⚠️ both receivers blocked on decks owed a visual read** |
...
| `op-cat` | **Index myopia as a REFRACTIVE ERROR** | `op-refract` | ☐ |
