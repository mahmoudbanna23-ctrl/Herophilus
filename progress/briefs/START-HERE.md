...
| `op-red` (L37) | **Iritis / iridocyclitis in full** — including **the JIA screening instruction `sys-9` left open** where `L23` line 290 ends mid-sentence | `op-uvea` | ☐ **⚠️ FIFTH row against this receiver, and `L13,14` is 0 chars over 41 pp** |
