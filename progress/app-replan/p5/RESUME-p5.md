...
- 2026-09-26: props v2 (Codex, props-v2-brief.md) -> p5/props-v2/{letters,tablet,pile}.png 1536x1024 real alpha, Sonnet check PASS (clean edge, no text). Fix 6 (lean-drafter, scroll-spike-fix6-brief.md): props trimmed to 600 px in scroll-spike/props/, entrances slide in from off-frame at opacity 1 with overshoot; other entrances already move. Builder could not rebuild round-6 probes (stall/ring/wipe numbers unreproduced). Opus refuter round 7 running -> REFUTE-scroll-spike-round7.md, films D:/tmp-spike-ref7/film/. Uncommitted.
- 2026-09-26: refuter round 7 PASS (0 major; m1 letters 82% keyframe undershot -7vw -> fixed inline to -3vw, same shape as tablet/pile, not re-probed; cosmetic NOTES lines 18/42 say round-6 probes gone - they are in D:/tmp-spike-ref6b/). Props 2.00x at 1600 wide, opacity 1 every frame, stall 0.583, ring 2.8-5.4, sweep 0 fail. Films after m1 fix: D:/tmp-spike-film7/spike-{desktop-1280x800,phone-390x844}.mp4 sent to owner.

- 2026-09-26 OWNER NEW DIRECTION: desk becomes the app, real 3D (three r147 vendored), books open to Lectures/Questions, every desk item interactive, short first-visit intro. Plan `p5/PLAN-3d-desk-2026-09-26.md` DRAFT awaiting go. ENT panel clipping reported in film7. Scroll spike superseded as landing.
